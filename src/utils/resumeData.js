...
export default {
    ...
    address: 'Cavite',
    phone: '+63 9958143127',
    cvLink:'https://github.com/festoqufx/Resume2.pdf',
    ...
    about: 'Ornare massa eget egestas purus. Risus nullam eget felis eget nunc lobortis mattis aliquam. Quis viverra nibh cras pulvinar mattis nunc sed blandit libero. Nunc congue nisi vitae suscipit tellus. Mattis pellentesque id nibh tortor. Vitae auctor eu augue ut lectus. Cursus in hac habitasse platea dictumst quisque sagittis purus. Pharetra et ultrices neque ornare aenean euismod elementum. Proin nibh nisl condimentum id venenatis. Cras fermentum odio eu feugiat pretium. Magna ac placerat vestibulum lectus mauris ultrices eros in. Massa id neque aliquam vestibulum. Odio facilisis mauris sit amet massa vitae tortor. Orci a scelerisque purus semper. Eget arcu dictum varius duis. Sed augue lacus viverra vitae congue eu. Elit ut aliquam purus sit amet. Posuere lorem ipsum dolor sit amet. Diam in arcu cursus euismod.',

    experiences: [
        {
            title: 'DIGITAL CONTENT MANAGER',
			company: 'Visa',
            date: 'JULY 2016 - up to presents',
            description: 'AEM, Visual Studio, Bastion Host, Bootstrap, HTML5, CSS, JS, SharePoint.'
        },
        {
            title: 'BACK-END WEB DEVELOPER',
			company: 'QUINN DATA FACILITIES, INC.',
            date: 'OCT 2015 - JULY 2016',
            description: 'Laravel, MySQL, MsSQL, Postgres, Wordpress, Bootstrap, HTML5, CSS, JS'
        },
        {
            title: 'FRONT-END WEB DEVELOPER',
			company: 'SMART COMMUNICATION, INC.',
            date: 'MAY 2015 - SEPT 2015',
            description: 'Sitefinity, ASP.NET, C#, Bootstrap, HTML5, CSS, JS, JQUERY, SEO'
        }
    ],
    ...
    educations: [
        {
            title: 'BS InfoTech',
            date: '2005 - 2007',
            description: 'St. Anthony College Calapan City'
        },
        {
            title: 'Associate in CompTech',
            date: '2003 - 2004',
            description: 'STI'
        },
    ],
    ...
    skills: [
        {
            title: 'FRONT-END',
            description: ["Javascript", "ReactJS", "TypeScript", "Bootstrap", "Material UI"]
        },
        {
            title: 'BACK-END',
            description: ["laravel", "PHP", "NodeJS"]
        },
        {
            title: 'DATABASES',
            description: ["My SQL", "Firebase"]
        },
        {
